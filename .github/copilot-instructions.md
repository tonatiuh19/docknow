...
- Never use emoji icons in the UI - always use proper icon libraries for a polished look
...
- **If you encounter any TypeScript type errors, fix them immediately** - do not ignore or bypass type issues
- Ensure all types are correct and consistent across client, server, and shared
- Use TypeScript's type inference and interfaces to maintain type safety throughout the codebase
