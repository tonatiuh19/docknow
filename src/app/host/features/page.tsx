...
export default function FeaturesPage() {
  return (
    <>
      <MetaHelmet
        title="Feature Requests | DockNow Host"
        description="Request new features and integrations"
        noindex={true}
        nofollow={true}
      />
      <div className="p-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-md mx-auto">
            Have an idea for a new feature? Let us know and we'll work with you
            to make it happen.
          </p>
