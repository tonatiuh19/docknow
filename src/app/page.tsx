        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group backdrop-blur-xl bg-white/70 border border-gray-200/50 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              ...
              <p className="text-gray-600 leading-relaxed">
                Book your slip in seconds with instant confirmation through our
                web or mobile app. No waiting, no hassle.
              </p>
            </div>
            ...
            <div className="group backdrop-blur-xl bg-white/70 border border-gray-200/50 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              ...
              <p className="text-gray-600 leading-relaxed">
                Safe and secure transactions powered by Stripe with full payment
                protection and instant receipts.
              </p>
            </div>
          </div>
        </div>
